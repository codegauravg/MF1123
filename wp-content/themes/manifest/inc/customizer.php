<?php
/**
 * Education Sector Website Modal Theme Customizer.
 *
...
function manifest_customize_preview_js() {
	wp_enqueue_script( 'manifest_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
