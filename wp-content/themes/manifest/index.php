 ...
 */
/**
 * Variables are delcared after this block comment
 */
...
get_header(); ?>
    ...
    <!-- Start first slide -->
    <div class="da-slide">
        <h2 class="fittext2">Vision 2015 MHRD Website</h2>
        <h4>Clean, Responsive &amp; Corruption-Free</h4>
        <p>Welcome to the visionary website of Ministry of Human Resource Development</p>
        <a target="_blank" href="http://www.mhrd.gov.in/" class="da-link button">Read more in the Previous Site</a>
        <div class="da-img">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Slider01.png" alt="image01" width="320">
        </div>
    </div>
    <!-- End first slide -->
    <!-- Start second slide -->
    <div class="da-slide">
        ...
        <div class="da-img">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Slider02.jpg" width="320" alt="image02">
        </div>
    </div>
    <!-- End second slide -->
    <!-- Start third slide -->
    <div class="da-slide">
        ...
        <a href="#" class="da-link button">Read more</a>
        <div class="da-img">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Slider03.jpg" width="320" alt="image03">
        </div>
    </div>
    <!-- Start third slide -->
    ...
    <div class="span4">
        <div class="centered service">
            <div class="circle-border zoom-in">
                <img class="img-circle" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Service1.png" alt="service 1">
            </div>
            <h3>Modern Design</h3>
    ...
    <div class="span4">
        <div class="centered service">
            <div class="circle-border zoom-in">
                <img class="img-circle" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Service2.png" alt="service 2" />
            </div>
    ...
    <div class="span4">
        <div class="centered service">
            <div class="circle-border zoom-in">
                <img class="img-circle" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Service3.png" alt="service 3">
            </div>
            <h3>Clean Code</h3>
    ...
    <div id="slidingDiv" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio01.png" alt="project 1" />
        </div>
        <div class="span6">
    ...
    <div id="slidingDiv1" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio02.png" alt="project 2">
        </div>
        <div class="span6">
            <div class="project-description">
                <div class="project-title clearfix">
    ...
    <div id="slidingDiv2" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio03.png" alt="project 3">
        </div>
        <div class="span6">
            <div class="project-description">
                <div class="project-title clearfix">
    ...
    <div id="slidingDiv3" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio04.png" alt="project 4">
        </div>
        <div class="span6">
            <div class="project-description">
                <div class="project-title clearfix">
    ...
    <div id="slidingDiv4" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio05.png" alt="project 5">
        </div>
        <div class="span6">
            <div class="project-description">
                <div class="project-title clearfix">
    ...
    <div id="slidingDiv5" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio06.png" alt="project 6">
        </div>
        <div class="span6">
            <div class="project-description">
                <div class="project-title clearfix">
    ...
    <div id="slidingDiv6" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio07.png" alt="project 7">
        </div>
        <div class="span6">
            <div class="project-description">
                <div class="project-title clearfix">
    ...
    <div id="slidingDiv7" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio08.png" alt="project 8">
        </div>
        <div class="span6">
            <div class="project-description">
                <div class="project-title clearfix">
    ...
    <div id="slidingDiv8" class="toggleDiv row-fluid single-project">
        <div class="span6">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Portfolio09.png" alt="project 9">
        </div>
        <div class="span6">
            <div class="project-description">
                <div class="project-title clearfix">
    ...
    <div class="span4" id="first-person">
        <div class="thumbnail">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Team1.png" alt="team 1">
            <h3>John Doe</h3>
            <ul class="social">
                <li>
                    <a href="">
    ...
    <div class="span4" id="second-person">
        <div class="thumbnail">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Team2.png" alt="team 1">
            <h3>John Doe</h3>
            <ul class="social">
                <li>
                    <a href="">
    ...
    <div class="span4" id="third-person">
        <div class="thumbnail">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Team3.png" alt="team 1">
            <h3>John Doe</h3>
            <ul class="social">
                <li>
                    <a href="">
    ...
    <div class="row">
        <div class="span4">
            <div class="testimonial">
                ...
                <div class="whopic">
                    <div class="arrow"></div>
                    <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Client1.png" class="centered" alt="client 1">
                    <strong>John Doe
                        <small>Client</small>
                    </strong>
                </div>
        ...
        <div class="span4">
            <div class="testimonial">
                ...
                <div class="whopic">
                    <div class="arrow"></div>
                    <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Client2.png" class="centered" alt="client 2">
                    <strong>John Doe
                        <small>Client</small>
                    </strong>
                </div>
        ...
        <div class="span4">
            <div class="testimonial">
                ...
                <div class="whopic">
                    <div class="arrow"></div>
                    <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Client3.png" class="centered" alt="client 3">
                    <strong>John Doe
                        <small>Client</small>
                    </strong>
                </div>
    ...
    <ul class="row client-slider" id="clint-slider">
        <li>
            <a href="">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/clients/ClientLogo01.png" alt="client logo 1">
            </a>
        </li>
        <li>
            <a href="">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/clients/ClientLogo02.png" alt="client logo 2">
            </a>
        </li>
        <li>
            <a href="">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/clients/ClientLogo03.png" alt="client logo 3">
            </a>
        </li>
        <li>
            <a href="">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/clients/ClientLogo04.png" alt="client logo 4">
            </a>
        </li>
        <li>
            <a href="">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/clients/ClientLogo05.png" alt="client logo 5">
            </a>
        </li>
        <li>
            <a href="">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/clients/ClientLogo02.png" alt="client logo 6">
            </a>
        </li>
        <li>
            <a href="">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/clients/ClientLogo04.png" alt="client logo 7">
            </a>
        </li>
    </ul>
    </div>
